...
class PlayConfig(ConfigBase):
    def __init__(self):
        ...
        self.policy_decay_power = 65

        # Using a solver is a kind of cheating!
        self.use_solver_turn = None
        self.use_solver_turn_in_simulation = None
...
class TrainerConfig(ConfigBase):
    def __init__(self):
        ...
        self.total_epoch_per_run = 1
        self.delete_self_play_after_number_of_training = 5  # control ratio of train:self data.
        self.lr_schedules = [
            (0, 0.01),
            (150000, 0.001),
            (300000, 0.0001),
